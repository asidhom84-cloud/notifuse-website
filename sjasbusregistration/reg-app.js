...
import { api, ApiError, copyText, esc, fmtDate, local, num, session, toast, tokenFrom } from './reg-common.js?v=22';
import { registrationForm } from './reg-form.js?v=22';
import { getLang, initLang, setLang, t } from './reg-i18n.js?v=22';
import { renderDemandMap, renderMyBusRoute } from './reg-mybus.js?v=22';
