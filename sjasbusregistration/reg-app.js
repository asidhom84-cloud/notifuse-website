...
import { api, ApiError, copyText, esc, fmtDate, local, num, session, toast, tokenFrom } from './reg-common.js?v=10';
import { registrationForm } from './reg-form.js?v=10';
import { getLang, initLang, setLang, t } from './reg-i18n.js?v=10';
import { renderDemandMap, renderMyBusRoute } from './reg-mybus.js?v=10';
