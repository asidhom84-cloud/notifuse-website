...
const AR = {
  ...
  'Afternoon route': 'خط سير العودة (بعد الظهر)',
  'Morning': 'الصباح',
  'Afternoon': 'بعد الظهر',
  'Morning (pickup)': 'الصباح (الركوب)',
  'Afternoon (drop-off)': 'بعد الظهر (النزول)',
  'Estimated drop-off {time}': 'موعد النزول التقريبي {time}',
  'View afternoon route': 'عرض خط سير العودة',
  'leaves {time}': 'يتحرك {time}',
  '{n} stops': '{n} محطة',
  'Stop {n}': 'محطة {n}',
  'YOU': 'أنت',
  'Start': 'البداية',
